...
function useReactive(reactiveAdapter, props) {
  ...
  var events = reactiveEvents.reduce(function (eventResult, name) {
    eventResult[core.camelize("on ".concat(name))] = function (callback) {
...
function useLegacyReactive(reactiveAdapter, props) {
  ...
  result = vue.reactive(__assign(__assign(__assign({}, reactiveState), methods), events));
  return result;
}

exports.useLegacyReactive = useLegacyReactive;
