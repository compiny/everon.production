import { c as defineEventHandler, r as readBody, i as db, q as products } from '../../../_/nitro.mjs';
...
const filterCount = defineEventHandler(async (event) => {
  try {
    ...
    const filteredProducts = allProducts.filter((product) => {
      try {
        ...
        for (const [filterName, filterValue] of Object.entries(attributeFilters)) {
          const productAttribute = attributes.find((attr) => attr.name === filterName);
...
export { filterCount as default };
//# sourceMappingURL=filter-count.mjs.map
